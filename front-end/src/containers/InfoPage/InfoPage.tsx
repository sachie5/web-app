...
const InfoPage = ({ anime }: InfoPageProps) => {
  ...
  return (
    <section className="information">
      ...
      <h4 className="information__text--extra">Episodes: {animes.episodes}<br/> Studio: {!animes || !animes?.information?.studio ? "Unknown" : animes.information.studio}</h4>
      ...
      <p className="information__text--description">{!animes || !animes?.information?.animeDescription ? "Unknown" : animes.information.animeDescription}</p>
      </section>
    </section>
  );
};
